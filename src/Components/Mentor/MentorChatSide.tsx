        ...
        <div className="flex gap-1 pl-1">
            <div className="w-3/12 h-screen  relative  border border-black flex gap-2 mt-2 p-1  ">
                <div className="w-full h-full  0">
                    ...
                    <div className="w-full h-16 mt-1 bg-white border border-black" onClick={()=>{setSelectedchat(itmes)}}>
                    ...
                    <div className="w-full h-screen  relative ">
                        <div className="w-full h-20   z-50 absolute p-1 mt-2">
                            <div className="w-full h-full  flex justify-center items-center">
                                <h1 className="font-bold text-3xl text-black font-serif underline">Select Your Potential with Personalized Mentors</h1>
                            </div>
                        </div>
